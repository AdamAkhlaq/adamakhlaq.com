...
import type { RecipeMetadata } from "@/lib/recipe-types";
...
export function RecipeCard({ recipe, index }: RecipeCardProps) {
  ...
  // Handle both old (image) and new (images) format
  const imageUrl = Array.isArray(recipe.images)
    ? recipe.images[0]
    : (recipe as RecipeMetadata & { image?: string }).image ||
